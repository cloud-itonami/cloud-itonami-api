CREATE TABLE IF NOT EXISTS public_funding_terms(project TEXT NOT NULL,version TEXT NOT NULL,terms TEXT NOT NULL,owner_id TEXT NOT NULL,PRIMARY KEY(project,version));
